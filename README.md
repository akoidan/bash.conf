...
### Hands on experience 
 ...
 - google calendar is awesome for macos, it has ability to create and accept events (comparing to Linux's things) and it also shows the notification on above other windows when the event is starting right b4 the event
  ...
  - you can't disable connected display , https://superuser.com/questions/27422/how-do-you-disable-a-secondary-display-on-a-mac
  ...
  - kernel_task eats uses all cores when IDLE, so even mouse freezes. Reboot helps. During that CPU temp is 60c.
